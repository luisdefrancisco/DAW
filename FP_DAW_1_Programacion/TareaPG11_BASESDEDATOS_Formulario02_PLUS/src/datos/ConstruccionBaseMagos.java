 ...
 * Antes la base de datos tiene que existir.
 *
 ...
 * 
 * Creamos la clase ConstrucionBaseMagos.java, que se encargará de inicializar la BBDD. 
 * De esta manera siempre partiremos de la misma base al abrir el programa
 * 
 * MIS APUNTES:
...
public class ConstruccionBaseMagos {

    ////// CONSTRUCTOR  //////
    public ConstruccionBaseMagos() throws SQLException {
